        ...
        <Box display="flex" justifyContent="space-between" alignItems="start">
          <Box>
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Tooltip
                title={t(
                  "The total time you've dedicated to your tasks using the focus timer.",
                )}
                arrow
              >
                <InfoIcon
        ...
        <Box display="flex" justifyContent="space-between" alignItems="start">
          <Box>
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Tooltip
                title={t(
                  "Shows what percentage of your total tasks you've marked as finished so far.",
                )}
                arrow
              >
                <InfoIcon
        ...
        <Box display="flex" justifyContent="space-between" alignItems="start">
          <Box>
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Tooltip
                title={t(
                  'A performance rating based on how many tasks you complete and how close you were to your estimated times.',
                )}
                arrow
              >
                <InfoIcon
        ...
        <Box display="flex" justifyContent="space-between" alignItems="start">
          <Box>
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Tooltip
                title={t(
                  'We calculate your breaks automatically by measuring the time between when you finish a focus session and start the next one.',
                )}
                arrow
              >
                <InfoIcon
        ...
        <Box display="flex" justifyContent="space-between" alignItems="start">
          <Box>
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Tooltip
                title={t(
                  'We identify your most productive hours based on the times of day when you manage to concentrate for the longest period.',
                )}
                arrow
              >
                <InfoIcon
