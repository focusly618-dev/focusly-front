    ...
    <Box>
      ...
      <SectionCard>
        <SectionHeader>
          <SectionTitle>
            ...
            <Typography>{t('Profile Picture')}</Typography>
          </SectionTitle>
        </SectionHeader>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 4, mt: 2 }}>
          ...
          <Box>
            ...
            >
              {t('This will be displayed on your profile and in team spaces.')}
            </Typography>
      ...
      <SectionCard>
        ...
        <Box sx={{ mb: 2 }}>
          <Typography
            variant="subtitle2"
            sx={{ fontWeight: 700, mb: 1, color: theme.palette.text.secondary }}
          >
            {t('Bio')}
          </Typography>
          <TextField
