...
export const Settings = () => {
    ...
    switch (activeTab) {
      ...
      case SettingsTab.Notifications:
        return {
          ...
          description: t(
            'Manage how and when you receive alerts for your focus sessions, breaks, and productivity insights.',
          ),
        };
      case SettingsTab.Schedule:
        return {
          title: t('Schedule & Energy Settings'),
          description: t(
            'Define your availability, work rhythm, and let our AI detect your peak productivity windows to optimize your calendar.',
          ),
        };
      case SettingsTab.Focus:
        return {
          title: t('Focus Engine Configuration'),
          description: t(
            'Customize how our AI optimizes your deep work sessions, manages your breaks, and shields you from distractions based on your energy levels.',
          ),
        };
      default:
        return {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: t('Schedule & Energy'),
      icon: <AccessTimeIcon fontSize="small" />,
    },
    {
      id: SettingsTab.Focus,
      label: t('Focus Engine'),
