...
export const SortPopover = ({
  ...
  const isSelected = (sort: string, order: string) =>
    selectedSort === sort && selectedOrder === order;
  ...
  return (
    ...
    >
      <Section>
        <SectionTitle>{t('Sort By')}</SectionTitle>

        <ItemRow onClick={() => handleSelect('deadline', 'asc')}>
          <ItemLabel>
            <AccessTimeIcon
              sx={{
                color: isSelected('deadline', 'asc') ? '#58a6ff' : '#8b949e',
                fontSize: 20,
              }}
            />
            <Typography
              ...
              sx={{
                fontSize: '13px',
                color: isSelected('deadline', 'asc') ? '#c9d1d9' : '#8b949e',
              }}
            >
              {t('Soonest Deadline')}
            </Typography>
          </ItemLabel>
          {isSelected('deadline', 'asc') && (
            <CheckIcon sx={{ color: '#58a6ff', fontSize: 16 }} />
          )}
        </ItemRow>
        ...
        <ItemRow onClick={() => handleSelect('priority_level', 'desc')}>
          <ItemLabel>
            <PriorityHighIcon
              sx={{
                color: isSelected('priority_level', 'desc')
                  ? '#58a6ff'
                  : '#8b949e',
                fontSize: 20,
              }}
          ...
          {isSelected('priority_level', 'desc') && (
            <CheckIcon sx={{ color: '#58a6ff', fontSize: 16 }} />
          )}
        </ItemRow>
        ...
        <ItemRow onClick={() => handleSelect('estimate_minutes', 'asc')}>
          <ItemLabel>
            <SwapVertIcon
              sx={{
                color: isSelected('estimate_minutes', 'asc')
                  ? '#58a6ff'
                  : '#8b949e',
                fontSize: 20,
              }}
            ...
            >
              {t('Estimated Effort (Low to High)')}
            </Typography>
          </ItemLabel>
          {isSelected('estimate_minutes', 'asc') && (
            <CheckIcon sx={{ color: '#58a6ff', fontSize: 16 }} />
          )}
        </ItemRow>
        ...
        <ItemRow onClick={() => handleSelect('created_at', 'desc')}>
          <ItemLabel>
            <HistoryIcon
              sx={{
                color: isSelected('created_at', 'desc') ? '#58a6ff' : '#8b949e',
                fontSize: 20,
              }}
            />
            <Typography
              ...
              sx={{
                fontSize: '13px',
                color: isSelected('created_at', 'desc') ? '#c9d1d9' : '#8b949e',
              }}
            >
              {t('Recently Created')}
            </Typography>
          </ItemLabel>
          {isSelected('created_at', 'desc') && (
            <CheckIcon sx={{ color: '#58a6ff', fontSize: 16 }} />
          )}
        </ItemRow>
      </Section>
